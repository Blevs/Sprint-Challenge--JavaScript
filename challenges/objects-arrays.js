...
const uni = graduates.map(({university}) => university).filter(univ => univ.match(/Uni/g));
console.log(uni);
...
*/
// .forEach only works with side effects, so this is how I assume you want is
// solved instead of using map
const animalNames = [];
